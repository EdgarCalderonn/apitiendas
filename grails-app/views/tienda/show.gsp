...
<html>
    ...
    <body>
        ...
        <div id="show-tienda" class="content scaffold-show" role="main">
            ...
            <f:display bean="tienda" />
            <g:form resource="${this.tienda}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tienda}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
