...
<html>
    ...
    <body>
        ...
        <div id="edit-tienda" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.tienda}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.tienda}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.tienda}" method="PUT">
                <g:hiddenField name="version" value="${this.tienda?.version}" />
                <fieldset class="form">
                    <f:all bean="tienda"/>
                </fieldset>
